...
RSpec.describe PostsController, type: :controller do
  ...
  context 'members user doing CRUD on a post they own' do
    before do
  ...
  context "moderators user doing CRUD on a post they don't own" do
    before do
      create_session(other_user)
    end
  ...
  context 'moderators user doing CRUD on a post they own' do
    before do
      create_session(my_user)
    end
